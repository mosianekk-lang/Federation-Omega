...
INDIVIDUAL_PROOF = {
    ...
    "CAP-036": (
        ProofClaim(MaturityStage.SOURCE_IMPLEMENTED, True, (
            "omega_one/hyperperformance.py: BoundedRetryController and AdaptiveConcurrencyController",
        )),
        ProofClaim(MaturityStage.DETERMINISTIC_TESTED, True, (
            "tests/test_omega_one_v086_hyperperformance.py: bounded retry, jitter, concurrency and shedding courts PASS",
        )),
    ),
    "CAP-045": (
        ProofClaim(MaturityStage.SOURCE_IMPLEMENTED, True, (
            "omega_one/hyperperformance.py: evaluate_paired_campaign champion/challenger court",
        )),
        ProofClaim(MaturityStage.DETERMINISTIC_TESTED, True, (
            "tests/test_omega_one_v086_hyperperformance.py: 30-pair, semantic, quality and p95 courts PASS",
        )),
    ),
    "CAP-047": (
        ProofClaim(MaturityStage.SOURCE_IMPLEMENTED, True, (
            "omega_one/hyperperformance.py: empirical semantic-convergence and truth-boundary gates",
        )),
        ProofClaim(MaturityStage.DETERMINISTIC_TESTED, True, (
            "tests/test_omega_one_v086_hyperperformance.py: mismatch, scenario and regression suppression courts PASS",
        )),
    ),
}
