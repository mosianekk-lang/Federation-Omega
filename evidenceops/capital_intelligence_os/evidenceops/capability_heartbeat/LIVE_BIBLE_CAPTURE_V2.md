...
3. **GitHub provider lane** — an approved provider worker may record repository commits with provider receipts and persistent cursors.
...
| Federation GitHub | No | Yes through an approved provider worker | GitHub commit/provider reference | P1-safe deltas only |
