...
def _build_authenticator():
    production=os.environ.get("ECERTIFY_ENV","development").strip().lower()=="production"
    ...
    if not provider or not secret or not key_id:
        if production:raise RuntimeError("PRODUCTION_IDENTITY_PROVIDER_AUTH_NOT_CONFIGURED")
        return None
