...
class CapabilityTwin:
    ...
    def resolution_complete(self) -> bool:
        """EVO-02 is about truthful resolution, not pretending the runtime is live.

        A twin may pass EVO-02 while accurately stating SOURCE_ONLY or ADAPTER_REQUIRED.
        It must, however, be fresh, sourced, read back, authority-bounded and semantically
        classified rather than UNKNOWN.
        """
        self.validate()
        return (
            self.fresh
