...
"""Canonical package entrypoint for the Superior Logic maturation shadow runtime.

Run as:
    python -m evidenceops.caseforge.maturation_shadow_cli ...

Keeping the provider entrypoint inside the package makes top-level imports independent
of the caller script directory and matches how the runtime is exercised in CI.
"""
...
from .maturation_shadow_runtime import (
    ShadowRuntimeInput,
