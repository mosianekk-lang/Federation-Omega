...
class JfrieV2Assurance:
    ...
    def evaluate(
        ...
        # EA-02: inherited core outcome receives an explicit execution receipt.
        ...
        # T008: readback alone cannot prove current node/version activation.
        ...
        # T003: originating/derivative dispute-date drift must be reconciled.
        date_drift = bool(
        ...
        # T004: sending/transmission is not proof of reading or knowledge.
        knowledge_inflation = (
        ...
        # T005: silence/non-response is not acceptance or agreement.
        ...
        # T009: referenced attachment completeness is explicit and exact-ID based.
        ...
        # EA-07: every asserted hash requires explicit object/byte scope.
        ...
        # EA-08: role/title evidence is distinct from act-specific authority.
        ...
        # T011/C098: generated controls cannot self-promote from generation alone.
        ...
        # Exact duplicate blockers collapse; original core blocker wording is preserved.
