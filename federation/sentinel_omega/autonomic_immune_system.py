...
maintenance away from the owner's creative work. This module plans and
governs repairs; provider-specific executors remain separate and must supply
their own authority and semantic readback.
"""
...
class DependencyGraph:
    """Small directed graph for deterministic blast-radius and reroute reasoning."""
    ...
    def decide(
        ...
        *,
        ...
        eligible = [
            ...
            and not self.memory.unchanged_route_failed(
                fingerprint, r, state_epoch=state_epoch
            )
        ]
        eligible.sort(
            key=lambda r: (
