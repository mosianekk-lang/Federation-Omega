...
SOURCE_SHA = "03b07b8692424b07e9dd0ae614c906b0075f3310"
ARTIFACT_DIGEST = "ddf03a94b9153f79cf815cb8c6e938350de52d4c30491c2586af4ffd41a05f87"
...
class AlternateExecutionPlaneCheckpointV31Tests(unittest.TestCase):
    ...
    def test_checkpoint_projection_hashes_and_dependency_order(self):
        for payload, field, expected in (
            (self.checkpoint, "checkpoint_sha256", "4e5815bee2e5ee54f13f76aa77f86d0bcf6d0175764782ecdf0bffea9aac3da8"),
