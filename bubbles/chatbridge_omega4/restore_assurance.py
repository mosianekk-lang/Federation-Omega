...
class RestoreAssuranceEngine:
    ...
    def assess(
        ...
        exact("restored_objective", observed.restored_objective, "Restore the recorded objective from the Governance Capsule.")
        exact("restored_next_action", observed.restored_next_action, "Restore the exact next action; reconcile rather than invent a new plan.")
        ...
        if expected_live_bible and expected_live_bible != observed.live_bible_ref:
            findings.append(RestoreFinding(
                ...
                "Read the bound Local Live Bible and latest checkpoint before resuming.",
            ))
