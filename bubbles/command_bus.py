    ...
    *,
    ...
    if actor not in ALLOWED_ACTORS:
        return {
            ...
            "reason": "Actor is not allowed by the Bubbles command-bus contract.",
    ...
    decision_record = {
        **asdict(decision),
        "route_kind": decision.route_kind.value if decision.route_kind else None,
    }
