...
Run the synthetic failure and repaired-route fixtures:
...
The blocked route exits 7; the repaired file-reference route exits 0. These fixtures are synthetic regression evidence only and do not send mail or perform provider effects.
