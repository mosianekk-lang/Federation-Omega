...
UPGRADE_GENOME: tuple[UpgradeGene, ...] = (
    ...
    UpgradeGene("HG-SOL62-201", "CODEX_CONCURRENCY", "isolated_worktree_agent_lane", ("codex","worktree","parallel","repo","conflict",), "OpenAI Codex app public worktree mechanism generalized into FDOF/Work Plane", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-202", "CODEX_CONTEXT", "project_thread_context_partition", ("codex","thread","project","context","session",), "OpenAI Codex project/thread workflow generalized into SOL/ChatBridge context partitioning", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-203", "CODEX_CONTROL", "queued_steering_injection", ("codex","steer","queue","running","prompt",), "OpenAI Codex queued/steering prompt mechanism generalized into MissionIR/Work Plane", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-204", "CODEX_COGNITION", "speculative_side_branch_fanin", ("codex","side","branch","speculative","analysis",), "OpenAI Codex side-chat mechanism generalized into bounded speculative branch/fan-in", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-205", "CODEX_PLANNING", "durable_goal_subgraph", ("codex","goal","milestone","dag","plan",), "OpenAI Codex goals generalized into durable MissionIR subgraphs", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-206", "CODEX_PROOF", "inline_diff_review_receipt", ("codex","diff","review","comment","code",), "OpenAI Codex inline review generalized into ProofOS/GitHub Airlock receipts", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-207", "CODEX_DELIVERY", "automation_review_inbox", ("codex","automation","review","inbox","background",), "OpenAI Codex Automations review queue generalized into DeliveryJournal/Work Plane", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-208", "CODEX_SCHEDULING", "scheduled_automation_adapter", ("codex","schedule","automation","recurring","background",), "OpenAI Codex Automations schedule mechanism rebound to Alpha-Omega/FO-GAS/Genesis", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-209", "CODEX_SCHEDULING", "cloud_trigger_event_adapter", ("codex","trigger","event","webhook","cloud",), "OpenAI Codex/Agents trigger direction generalized into existing FUSE event wake path", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-210", "CODEX_EXECUTION", "managed_harness_provider_cell", ("codex","harness","managed","agent","cloud",), "OpenAI Agents API managed Codex harness generalized as optional FUSE provider cell", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-211", "CODEX_CONTEXT", "automatic_context_compaction_checkpoint", ("codex","context","compaction","checkpoint","long",), "OpenAI Agents API automatic context compaction generalized with SOL checkpoint hydration", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-212", "CODEX_MULTI_AGENT", "subagent_context_isolation", ("codex","subagent","delegate","context","specialist",), "OpenAI Agents API subagents generalized into Forest v2/Cognitive Council isolation", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-213", "CODEX_TOOLS", "programmatic_tool_call_plan", ("codex","tool","programmatic","call","batch",), "OpenAI agent programmatic tool calling generalized into FIO/MCP typed call programs", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-214", "CODEX_SKILLS", "lazy_skill_directory_loader", ("codex","skill","lazy","directory","instruction",), "OpenAI Agent Skills capability directories generalized into SkillForge/Capability Market lazy hydration", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-215", "CODEX_SANDBOX", "hosted_selfhosted_nosandbox_contract", ("codex","sandbox","hosted","self-hosted","execution",), "OpenAI Agents API environment modes generalized into Execution Power Pool carrier contract", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-216", "CODEX_SANDBOX", "outbound_only_executor_reconnect", ("codex","executor","outbound","websocket","reconnect",), "OpenAI self-hosted sandbox exec-server outbound reconnect generalized into Windows Native/Genesis carrier", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-217", "CODEX_SECURITY", "restricted_environment_key_separation", ("codex","key","restricted","credential","secret",), "OpenAI sandbox restricted environment key model generalized into Secure Capability Box/FIO", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-218", "CODEX_AUTHORITY", "approval_interrupt_serialized_resume", ("codex","approval","interrupt","resume","state",), "OpenAI agent approval interruptions generalized into FDOF/SICF/SOL exact-state resume", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-219", "CODEX_CONTINUITY", "cross_client_session_portability", ("codex","client","cli","ide","mobile","session",), "OpenAI Codex shared app/CLI/IDE continuity generalized into detachable FUSE client hydration", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-220", "CODEX_CONTROL", "remote_owner_control_plane", ("codex","remote","mobile","review","steer",), "OpenAI Codex Remote generalized into FUSE Mobile/Workspace owner steering", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-221", "CODEX_CONTEXT", "instruction_distillation_prompt_debloat", ("codex","agents.md","prompt","instruction","context","bloat",), "OpenAI Codex/GPT-6 Astra instruction guidance generalized into SkillForge/CFBE harness simplification", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-222", "CODEX_LEARNING", "trace_eval_agent_improvement_loop", ("codex","trace","eval","improve","failure",), "OpenAI Codex trace/eval improvement loop generalized into CFBE/Failure Harvest/RAEFI", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-223", "CODEX_SOURCE", "worktree_promotion_fanin", ("codex","worktree","merge","promotion","source",), "OpenAI Codex worktree review generalized into FDOF/GitHub Airlock promotion fan-in", "CANDIDATE_RESIDUAL"),
    UpgradeGene("HG-SOL62-224", "CODEX_DURABILITY", "long_run_harness_recovery", ("codex","long-running","recovery","disconnect","resume",), "OpenAI Agents API durable harness generalized into SOL/Genesis/Portable State recovery", "CANDIDATE_RESIDUAL"),
)
