...
- Provider or semantic failure opens a breaker; invalid user input cannot poison a provider route; recovery requires two fresh proofs with distinct verifier, proof and evidence identities.
