import {createMirrorV3} from '../fuse_runtime/output_mirror_v3.mjs';
...
const cfg={enabled:true,version:'3.0.0',reality_clause_preserved:true,power_diary:{source_sha256:'3d95834ff0070e06c8de385b9240c65490d9b71ceb63fa5e3364f407261c0495',chapter_count:40,family_count:17},intent_similarity_floor:0.18,developer1000:{count:1000,sha256:'f7277e2244f1d59849f64f5d4f48af7c20de14ecb8573dba763353bf6084cb7e'},benchmark_court:{cases:1000,dataset_sha256:'d69644412e285ef3a5baeab0b0ef4683ae42280ddca0bdb4a0ea2ce3a5fd6510'}};
function base(prompt,lang){return {objective:prompt,route:'ENGINEERING_VERIFIED',completion_state:'COMPLETE_VERIFIED',
 ...
 source_refs:['provider','source'],manual_user_tasks:[],machine_route_available:true,mission_graph:{steps:[1]},surface_portfolio:{selected:[{surface:'fuse'},{surface:'provider2'}]},language:lang};}
...
const report={schema:'FUSE_OUTPUT_MIRROR_V3_DEVELOPER1000_REGRESSION',cases:cases.length,v1_1:score('v1'),v3:score('v2'),
