...
The admission layer binds route selection to the exact v30 checkpoint and projection, current source SHA, current Phoenix artifact digest, fresh GitHub installation readback and unchanged commercial truth.

## Fresh provider truth

- current source: `03b07b8692424b07e9dd0ae614c906b0075f3310`;
- `phoenix-freeze/verified`: success after readback repair, run `30971741164`, job `92197940711`;
