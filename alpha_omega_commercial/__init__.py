...
The crash-safe atomic authority-snapshot control plane is the supported
...
prepare/commit/rollback and a durable recovery bundle that can restore an
unterminated action before new work after process restart. Earlier control
