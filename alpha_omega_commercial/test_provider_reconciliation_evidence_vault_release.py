...
from prove_provider_reconciliation_evidence_vault_release import prove, validate


class ProviderReconciliationEvidenceVaultReleaseTests(unittest.TestCase):
    ...
    def test_proof_is_deterministic_and_preserves_truth_boundary(self) -> None:
        ...
        self.assertEqual(one["checks_required"], 18)
    ...
    def test_changed_drive_hash_fails_closed(self) -> None:
        ...
        receipt_path = (
            ...
            / "provider_reconciliation_evidence_vault_release_receipt.json"
        )
        ...
        with patch(
            "prove_provider_reconciliation_evidence_vault_release.load",
